function Footer() {
  return (
    ...
    <div className="flex bg-amber-300w-full">
        
        <div className="bg-[#030911] w-1/2 h-63 text-[#ABAFB5]">
         <div className="m-5">
          <h1>Building software that makes <br />an impact. lets connect and <br />build something great together.</h1>
          </div>
        </div>

        <div  className="bg-[#030911] w-1/2 h-63">
       ...
       <div className="flex bg-[#030911] text-center"><h1 className="text-amber-50 ">@ 2025 Anthony George. All rights reserved.</h1></div>
    </>
  )
}
